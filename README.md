...
- <img src="https://sverklo.com/favicon.ico" height="14" /> [sverklo/sverklo](https://github.com/sverklo/sverklo) - Local-first MCP server for code intelligence with a published peer-reviewable benchmark. 37 MCP tools: hybrid search (BM25 + ONNX embedding + PageRank), blast-radius analysis, file-dependency graphs, code audit, and bi-temporal memory pinned to git SHAs. MIT-licensed alternative to Greptile and Sourcegraph Cody. Zero config — auto-detects Claude Code, Cursor, Windsurf, Zed.
