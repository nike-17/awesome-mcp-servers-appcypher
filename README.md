...
- <img src="https://sverklo.com/favicon.svg" height="14" /> [Sverklo](https://github.com/sverklo/sverklo) - Local-first repo memory and code-intelligence MCP for Claude Code, Cursor, Windsurf, and Codex CLI. Provides semantic search, symbol lookup, impact analysis, diff-aware review, git-pinned decisions, and no-write proof receipts before setup.
